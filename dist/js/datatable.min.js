...
(function (k) {
    ...
    function G(a) {
        ...
        k.each(a, function (f, e) {
            (b = f.match(/^([^A-Z]+?)([A-Z])/)) &&
                ...
                ((c = f.replace(b[0], b[2].toLowerCase())), (d[c] = f), "o" === b[1] && G(a[f]));
        });
        a._hungarianMap = d;
    }
    function O(a, b, c) {
                ...
                a.iDrawError != f &&
                    ...
                    (aa(
                        ...
                        "Requested unknown parameter " +
                            ("function" == typeof e.mData ? "{function}" : "'" + e.mData + "'") +
                            " for row " +
                            b +
                            ", column " +
                            c,
    ...
    function Jb(a) {
        ...
        b = k("<div/>", { id: e.f ? null : c + "_filter", class: b.sFilter }).append(
            k("<label/>").append(h)
        );
        var l = function () {
    ...
    function Xa(a) {
        ...
        if (d || (!t && !e && !f && h == na(a) && h == n.length))
            ...
            for (v = 0; v < l.length; v++)
                (r = c[l[v]]),
                    (n[v].style.width =
                        null !== r.sWidthOrig && "" !== r.sWidthOrig ? K(r.sWidthOrig) : ""),
                    r.sWidthOrig &&
                        e &&
                        k(n[v]).append(
                            k("<div/>").css({
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    e = function () {
                        ...
                        if (g.aaData) for (h = 0; h < g.aaData.length; h++) ea(r, g.aaData[h]);
                            ...
                            (r.bDeferLoading || "dom" == P(r)) && Ga(r, k(r.nTBody).children("tr"));
    ...
    D.extend = function (a, b, c) {
        if (c.length && b && (b instanceof D || b.__dt_wrapper)) {
            ...
            for (d = c.length; e < d; e++) {
                var g = c[e];
                b[g.name] =
                    "function" === g.type ? f(a, g.val, g) : "object" === g.type ? {} : g.val;
    ...
    D.register = w = function (a, b) {
        if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) D.register(a[c], b);
            ...
            for (c = d.length; a < c; a++) {
                ...
                h ||
                    ((h = { name: g, val: {}, methodExt: [], propExt: [], type: "object" }),
                    f.push(h));
                a === c - 1
                    ? ((h.val = b),
                      (h.type =
    ...
    var xc = function (a, b, c, d) {
        ...
        pc = function (a, b) {
            ...
            c.length &&
                ...
                ((a = c[0].aoData[a[0]]),
                a._details &&
                    ((a._detailsShow = b) ? a._details.insertAfter(a.nTr) : a._details.detach(),
                    yc(c[0])));
        },
        yc = function (a) {
            var b = new D(a),
                ...
                b.on("column-visibility.dt.DT_details", function (d, f, e, g) {
                    if (a === f)
                        for (f = na(f), e = 0, g = c.length; e < g; e++)
                            (d = c[e]),
                                d._details && d._details.children("td[colspan]").attr("colspan", f);
                }),
        ...
        return tb(
            ...
            function (r) {
                ...
                if (k.isPlainObject(r))
                    return r.column !== q && r.row !== q && -1 !== k.inArray(r.row, f) ? [r] : [];
                A = g
                    .filter(r)
                    .map(function (E, H) {
    ...
    u.versionCheck = u.fnVersionCheck = function (a) {
        ...
        for (var c, d, f = 0, e = a.length; f < e; f++)
            if (((c = parseInt(b[f], 10) || 0), (d = parseInt(a[f], 10) || 0), c !== d))
                return c > d;
        return !0;
    };
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sSearch: "Search:",
            sSearchPlaceholder: "Search For Country",
            sUrl: "",
